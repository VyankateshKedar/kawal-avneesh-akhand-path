    ...
    <section id="events" className="relative py-16 sm:py-24 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto space-y-10 sm:space-y-14">
        {events.map((event, index) => (
          ...
          >
            {/* Image Section */}
            <div className="relative w-full h-80 sm:h-96 md:h-[420px] bg-navy/10">
              <Image
                src={event.image}
                alt={event.imageAlt}
                fill
            ...
            <div className="bg-gradient-to-b from-white/80 to-white/60 backdrop-blur-sm p-6 sm:p-8 space-y-4">
              {/* Hashtag */}
              {event.hashtag && (
                <motion.div
                ...
                >
                  <span className="inline-block px-4 py-1.5 rounded-full bg-gold/20 border border-gold/30 text-gold-dark text-xs sm:text-sm tracking-wide font-medium">
                    {event.hashtag}
                  </span>
                </motion.div>
              )}
              ...
              {event.subtitle && (
                <p
                  className="text-navy/70 text-sm sm:text-base italic"
                  style={{ fontFamily: "var(--font-serif-body)" }}
                >
                  {event.subtitle}
                </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p
                    className="text-navy font-medium text-sm sm:text-base"
                    style={{ fontFamily: "var(--font-serif-body)" }}
                  >
                    {event.date}
                  </p>
                  <p
                    className="text-navy/70 text-xs sm:text-sm mt-0.5"
                    style={{ fontFamily: "var(--font-serif-body)" }}
                  >
                    {event.time}
                  </p>
                  {event.followedBy && (
                    <p className="text-gold-dark text-xs mt-1 italic font-medium">
                      {event.followedBy}
                    </p>
                  )}
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <p
                  className="text-navy/80 text-sm sm:text-base font-semibold leading-relaxed"
                  style={{ fontFamily: "var(--font-serif-body)" }}
                >
                  {event.location}
                </p>
